...
class SectionHeadersFootersContentInsetsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.title = "Section Headers/Footers Content Insets"
        configureHierarchy()
        configureDataSource()
    }
}

extension SectionHeadersFootersContentInsetsViewController {
...
extension SectionHeadersFootersContentInsetsViewController: UICollectionViewDelegate {
